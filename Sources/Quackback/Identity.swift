...
/// The identity to pass to `Quackback.configure(_:identify:)` so the widget
...
public enum Identity {
    /// Start an anonymous session. The widget prompts for an email inline the first
    /// time the user posts feedback.
    case anonymous
